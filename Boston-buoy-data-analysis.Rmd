...
pacman::p_load(ggplot2,lubridate,stringr,tidyverse,ggpubr)
load('Buoy.Rdata')
```
...
At first, we chose to separate the single 'for' loop into two, one for downloading data from NOAA and one to deal with formats issues, which has two advantages. First, 
...
### Trend of monthly average temperature per 
```{r}
M_W=0
